...
* ``compute_single_label_metrics`` — Subtask 1A (binary).
* ``compute_multilabel_metrics``    — Subtasks 1B / 1C (multi-label).
...
def compute_single_label_metrics(
    ...
    p = precision_score(y_true, y_pred, average=None, zero_division=0, labels=labels)
    r = recall_score(y_true, y_pred, average=None, zero_division=0, labels=labels)
    f = f1_score(y_true, y_pred, average=None, zero_division=0, labels=labels)
