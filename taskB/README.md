...
The aim of this task is to identify harmful Arabic prompts directed at large language models. Please follow the task website for the latest information: <https://araieval.github.io/ArGuard2026/taskB/>.
...
* Main folder: [data](./data)<br/>
  Contains files for Task B (Task 2) subtasks once released.
...
Task B (Task 2) focuses on textual harmful prompt detection for Arabic LLM safety evaluation. Given an Arabic prompt, systems determine whether it is safe or unsafe and classify unsafe prompts into harm domains.
...
- Subtask B2: TSV file with header `id<TAB>category<TAB>run_id`.
